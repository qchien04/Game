#include "HighPerformanceGameServer.h"
...
private:
    ...
    void handle_start_game_request(TCPConnection* conn, const ProtocolMessage& msg) {
        ...
        // Send to all players in room
            ...
            HighPerformanceGameServer::match_shards[shard_to_add][test_match->GetMatchId()] = std::move(test_match);

        
        
        // Notify all players about game start
        broadcast_game_start_notification(room_id,match_id);
